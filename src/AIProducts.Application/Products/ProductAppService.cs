...
[Authorize(AIProductsPermissions.Products.Default)]
    ...
    IProductAppService //implement the IProductAppService
{
        ...
        : base(repository)
    {
        ...
        GetPolicyName = AIProductsPermissions.Products.Default;
        GetListPolicyName = AIProductsPermissions.Products.Default;
        CreatePolicyName = AIProductsPermissions.Products.Create;
        UpdatePolicyName = AIProductsPermissions.Products.Edit;
        DeletePolicyName = AIProductsPermissions.Products.Delete;
    }

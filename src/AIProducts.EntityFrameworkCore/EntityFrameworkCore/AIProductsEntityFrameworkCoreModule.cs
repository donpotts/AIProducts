...
public class AIProductsEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<AIProductsDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
                 ...
                 * See also AIProductsDbContextFactory for EF Core tooling. */
            options.UseSqlite();
        });
